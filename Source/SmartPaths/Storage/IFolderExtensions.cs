...
public static class IFolderExtensions
{
    ...
    public static async Task<IFile> CreateFile(this IFolder folder, AbsoluteFilePath path, byte[] contents, CollisionStrategy collisionStrategy = CollisionStrategy.FailIfExists) {
    ...
    public static Task<IFile> CreateFile(this IFolder folder, AbsoluteFilePath path, string utf8Contents, CollisionStrategy collisionStrategy = CollisionStrategy.FailIfExists) {
