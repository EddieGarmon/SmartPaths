...
public class ComputeRelativeOperatorTests
{
    ...
    public void InvalidFile(string startDir,
                            string endDir) {
    ...
    public void InvalidFolder(string startDir,
                              string endDir) {
        AbsoluteFolderPath start = startDir;
    ...
    public void ValidFile(string startDir,
                          string endFile,
                          string relativePath) {
        AbsoluteFolderPath start = startDir;
    ...
    public void ValidFolder(string startDir,
                            string endDir,
                            string relativePath) {
        AbsoluteFolderPath start = startDir;
        AbsoluteFolderPath end = endDir;
